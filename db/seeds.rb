...
product5 = Product.create(seller_user_id: user1.id, buyer_user_id: user2.id, brand_id: brand_n.id, category_id: brand_n.category_id, product_name: "ナイキ(Tシャツ)",introduction: "ナイキのTシャツです！ もう着ないので誰か着てください", product_size: 1, product_state: 1, who_pays_shipping_fee: 0, prefecture: profile1.prefecture_id, days_to_ship: 0, price: 1070, trade_state: 0, way_to_ship: 0)
...
product6 = Product.create(seller_user_id: user1.id, buyer_user_id: user2.id, brand_id: brand_n.id, category_id: brand_n.category_id, product_name: "ただのTシャツ",introduction: "ナイキのTシャツです！ もう着ないので誰か着てください", product_size: 1, product_state: 1, who_pays_shipping_fee: 0, prefecture: profile1.prefecture_id, days_to_ship: 0, price: 670, trade_state: 0, way_to_ship: 0)
...
product7 = Product.create(seller_user_id: user1.id, buyer_user_id: user2.id, brand_id: brand_n.id, category_id: brand_n.category_id, product_name: "ただのTシャツ",introduction: "ナイキのTシャツです！ もう着ないので誰か着てください", product_size: 1, product_state: 1, who_pays_shipping_fee: 0, prefecture: profile1.prefecture_id, days_to_ship: 0, price: 540, trade_state: 0, way_to_ship: 0)
ProductImage.create(product_id: product7.id, image: open("https://item-shopping.c.yimg.jp/i/j/elephant_846469"))
product8 = Product.create(seller_user_id: user1.id, buyer_user_id: user2.id, brand_id: brand_a.id, category_id: brand_a.category_id, product_name: "Tシャツ",introduction: "アシックスのTシャツです！ もう着ないので誰か着てください", product_size: 1, product_state: 1, who_pays_shipping_fee: 0, prefecture: profile1.prefecture_id, days_to_ship: 0, price: 700, trade_state: 0, way_to_ship: 0)
