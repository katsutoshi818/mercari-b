...
ProductSize.create(size_text: 'SS', size_type: 0)
ProductSize.create(size_text: 'S', size_type: 0)
ProductSize.create(size_text: 'M', size_type: 0)
ProductSize.create(size_text: 'L', size_type: 0)
ProductSize.create(size_text: 'LL', size_type: 0)
...
lady_t_shirt = lady_tops.children.create(category_name: "Tシャツ/カットソー(七分/長袖)", size_type: "0")
lady_t_shirt2 = lady_tops.children.create(category_name: "Tシャツ/カットソー(半袖/袖なし)", size_type: "0")
lady_shirt = lady_tops.children.create(category_name: "シャツ/ブラウス(七分/長袖)", size_type: "0")
lady_shirt2 = lady_tops.children.create(category_name: "シャツ/ブラウス(七分/長袖)", size_type: "0")
lady_poro_shirt = lady_tops.children.create(category_name: "ポロシャツ", size_type: "0")
lady_nit = lady_tops.children.create(category_name: "ニット/セーター", size_type: "0")
lady_parkar = lady_tops.children.create(category_name: "パーカー", size_type: "0")
lady_jersey = lady_tops.children.create(category_name: "ジャージ", size_type: "0")
lady_other = lady_tops.children.create(category_name: "その他")
lady_t_jacket = lady_outer.children.create(category_name: "テーラードジャケット", size_type: "0")
lady_n_jacket = lady_outer.children.create(category_name: "ノーカラージャケット", size_type: "0")
lady_g_jacket = lady_outer.children.create(category_name: "Gジャン/デニムジャケット", size_type: "0")
lady_l_jacket = lady_outer.children.create(category_name: "レザージャケット", size_type: "0")
lady_coat = lady_outer.children.create(category_name: "コート", size_type: "0")
lady_outer_other = lady_outer.children.create(category_name: "その他")
lady_d_pant = lady_pants.children.create(category_name: "デニム", size_type: "0")
lady_s_pant = lady_pants.children.create(category_name: "ショートパンツ", size_type: "0")
lady_w_pant = lady_pants.children.create(category_name: "ワークパンツ", size_type: "0")
lady_c_pant = lady_pants.children.create(category_name: "チノパン", size_type: "0")
lady_o_pant = lady_pants.children.create(category_name: "オーバーオール", size_type: "0")
lady_pant_other = lady_pants.children.create(category_name: "その他")
lady_m_scart = lady_scart.children.create(category_name: "ミニスカート", size_type: "0")
lady_h_scart = lady_scart.children.create(category_name: "ひざ丈スカート", size_type: "0")
lady_l_scart = lady_scart.children.create(category_name: "ロングスカート", size_type: "0")
lady_k_scart = lady_scart.children.create(category_name: "キュロット", size_type: "0")
lady_scart_other = lady_scart.children.create(category_name: "その他")
lady_m_onepeace = lady_onepeace.children.create(category_name: "ミニワンピース", size_type: "0")
lady_h_onepeace = lady_onepeace.children.create(category_name: "ひざ丈ワンピース", size_type: "0")
lady_l_onepeace = lady_onepeace.children.create(category_name: "ロングワンピース",size_type: "0")
...
sofa = interior.children.create(category_name: "ソファー/椅子", size_type: "0")
s_sofa = sofa.children.create(category_name: "シングルサイズ", size_type: "0")
d_sofa = sofa.children.create(category_name: "ダブルサイズ", size_type: "0")
t_sofa = sofa.children.create(category_name: "トリプルサイズ", size_type: "0")
...
product1 = Product.create(seller_user_id: user1.id, buyer_user_id: user2.id, brand_id: brand_n.id, category_id: brand_n.category_id, product_name: "ナイキのTシャツ",introduction: "ナイキのTシャツです！ もう着ないので誰か着てください", product_size_id: 1, product_state: 1, who_pays_shipping_fee: 1, prefecture_id: profile1.prefecture_id, days_to_ship: 1, price: 1000, trade_state: 0, way_to_ship: 0)
...
product2 = Product.create(seller_user_id: user1.id, buyer_user_id: user2.id, brand_id: brand_n.id, category_id: brand_n.category_id, product_name: "Tシャツ",introduction: "ナイキのTシャツです！ もう着ないので誰か着てください", product_size_id: 1, product_state: 1, who_pays_shipping_fee: 1, prefecture_id: profile1.prefecture_id, days_to_ship: 1, price: 600, trade_state: 0, way_to_ship: 0)
...
product3 = Product.create(seller_user_id: user1.id, buyer_user_id: user2.id, brand_id: brand_n.id, category_id: brand_n.category_id, product_name: "カットソー",introduction: "ナイキのTシャツです！ もう着ないので誰か着てください", product_size_id: 1, product_state: 1, who_pays_shipping_fee: 1, prefecture_id: profile1.prefecture_id, days_to_ship: 1, price: 800, trade_state: 0, way_to_ship: 0)
...
product4 = Product.create(seller_user_id: user1.id, buyer_user_id: user2.id, brand_id: brand_n.id, category_id: brand_n.category_id, product_name: "Tシャツ(ナイキ)",introduction: "ナイキのTシャツです！ もう着ないので誰か着てください", product_size_id: 1, product_state: 1, who_pays_shipping_fee: 1, prefecture_id: profile1.prefecture_id, days_to_ship: 1, price: 450, trade_state: 0, way_to_ship: 0)
...
product5 = Product.create(seller_user_id: user1.id, buyer_user_id: user2.id, brand_id: brand_n.id, category_id: brand_n.category_id, product_name: "ナイキ(Tシャツ)",introduction: "ナイキのTシャツです！ もう着ないので誰か着てください", product_size_id: 1, product_state: 1, who_pays_shipping_fee: 1, prefecture_id: profile1.prefecture_id, days_to_ship: 1, price: 1070, trade_state: 0, way_to_ship: 0)
...
product6 = Product.create(seller_user_id: user1.id, buyer_user_id: user2.id, brand_id: brand_n.id, category_id: brand_n.category_id, product_name: "ただのTシャツ",introduction: "ナイキのTシャツです！ もう着ないので誰か着てください", product_size_id: 1, product_state: 1, who_pays_shipping_fee: 1, prefecture_id: profile1.prefecture_id, days_to_ship: 1, price: 670, trade_state: 0, way_to_ship: 0)
...
product7 = Product.create(seller_user_id: user1.id, buyer_user_id: user2.id, brand_id: brand_n.id, category_id: brand_n.category_id, product_name: "ただのTシャツ",introduction: "ナイキのTシャツです！ もう着ないので誰か着てください", product_size_id: 1, product_state: 1, who_pays_shipping_fee: 1, prefecture_id: profile1.prefecture_id, days_to_ship: 1, price: 540, trade_state: 0, way_to_ship: 0)
ProductImage.create(product_id: product7.id, image: open("https://item-shopping.c.yimg.jp/i/j/elephant_846469"))
product8 = Product.create(seller_user_id: user1.id, buyer_user_id: user2.id, brand_id: brand_a.id, category_id: brand_a.category_id, product_name: "Tシャツ",introduction: "アシックスのTシャツです！ もう着ないので誰か着てください", product_size_id: 1, product_state: 1, who_pays_shipping_fee: 1, prefecture_id: profile1.prefecture_id, days_to_ship: 1, price: 700, trade_state: 0, way_to_ship: 0)
...
product9 = Product.create(seller_user_id: user1.id, buyer_user_id: user2.id, brand_id: brand_a.id, category_id: brand_a.category_id, product_name: "Tシャツ",introduction: "アシックスのTシャツです！ もう着ないので誰か着てください", product_size_id: 1, product_state: 1, who_pays_shipping_fee: 1, prefecture_id: profile1.prefecture_id, days_to_ship: 1, price: 490, trade_state: 0, way_to_ship: 0)
...
product10 = Product.create(seller_user_id: user1.id, buyer_user_id: user2.id, brand_id: brand_a.id, category_id: brand_a.category_id, product_name: "Tシャツ",introduction: "アシックスのTシャツです！ もう着ないので誰か着てください", product_size_id: 1, product_state: 1, who_pays_shipping_fee: 1, prefecture_id: profile1.prefecture_id, days_to_ship: 1, price: 2500, trade_state: 0, way_to_ship: 0)
ProductImage.create(product_id: product10.id, image: open("https://www.sports-ws.com/img/item/F123AS0/F123AS0177.jpg"))
product11 = Product.create!(seller_user_id: user3.id, buyer_user_id: user2.id, brand_id: brand_m.id, category_id: brand_m.category_id, product_name: "ソファー",introduction: "粗大ゴミです", product_size_id: 1, product_state: 1, who_pays_shipping_fee: 1, prefecture_id: profile3.prefecture_id, days_to_ship: 1, price: 10800, trade_state: 0, way_to_ship: 0)
...
product12 = Product.create(seller_user_id: user3.id, buyer_user_id: user2.id, brand_id: brand_m.id, category_id: brand_m.category_id, product_name: "ソファー",introduction: "粗大ゴミです", product_size_id: 1, product_state: 1, who_pays_shipping_fee: 1, prefecture_id: profile3.prefecture_id, days_to_ship: 1, price: 10800, trade_state: 0, way_to_ship: 0)
...
product13 = Product.create(seller_user_id: user3.id, buyer_user_id: user2.id, brand_id: brand_m.id, category_id: brand_m.category_id, product_name: "ソファー",introduction: "粗大ゴミです",  product_size_id: 1,product_state: 1, who_pays_shipping_fee: 1, prefecture_id: profile3.prefecture_id, days_to_ship: 1, price: 10800, trade_state: 0, way_to_ship: 0)
...
product14 = Product.create(seller_user_id: user3.id, buyer_user_id: user2.id, brand_id: brand_m.id, category_id: brand_m.category_id, product_name: "ソファー",introduction: "粗大ゴミです",  product_size_id: 1, product_state: 1, who_pays_shipping_fee: 1, prefecture_id: profile3.prefecture_id, days_to_ship: 1, price: 10800, trade_state: 0, way_to_ship: 0)
...
product15 = Product.create(seller_user_id: user3.id, buyer_user_id: user2.id, brand_id: brand_m.id, category_id: brand_m.category_id, product_name: "ソファー",introduction: "粗大ゴミです",  product_size_id: 1, product_state: 1, who_pays_shipping_fee: 1, prefecture_id: profile3.prefecture_id, days_to_ship: 1, price: 10800, trade_state: 0, way_to_ship: 0)
